...
const Join = () => {
  ...
  // form에 입력된 name 과 value 를 이용해서 state 를 업데이트 하겠다.
  // 매번 onChnange 가 별도 작성이 아닌 한 곳에서 관리하겠다.
          ...
          <table>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  {/* http://localghost/join?userid=홍길동 */}
                  <input
                    type="text"
                    id="userid"
                    name="userid"
              ...
              <tr>
                <th>EDUCATiON</th>
                <td>
                  <select naem="edu" id="edu" onChange={handleChange}>
              ...
              <tr>
                <th colSpan="2">
                  ...
                  주의사항 : 폼 안에서는 button type= "submit"이 기본*/}
